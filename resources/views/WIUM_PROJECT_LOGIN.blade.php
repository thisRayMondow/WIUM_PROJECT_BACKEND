...
<head>
    ...
    <style>
        /* CSS untuk mengatur halaman login ke tengah */
        .login-container {
            display: flex;
        ...
        .card {
            max-width: 400px; /* Lebar kartu maksimum */
            width: 100%;
        }
    </style>
...
<body class="bg-primary">
    <div class="login-container">
        <div class="card bg-info p-3">
            <!-- Header -->
            <header class="text-center border-bottom border-dark mb-3">
            ...
            <!-- Body - Form Login -->
            <main>
                <form method="POST" class="p-2" action="{{ route('login-Credential') }}">
                    @if(session('fail'))
                    ...
                    @csrf
                    <div class="mb-3">
                        <label for="username" class="form-label">Kode <i>(angka)</i> :</label>
                        <input type="text" class="form-control text-center" id="username" name="username" required pattern="[0-9+]+" maxlength="10">
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">PIN <i>(angka)</i> :</label>
                        <input type="password" class="form-control text-center" id="password" name="password" required pattern="[0-9+]+" maxlength="7">
                    </div>
                    <div class="text-end">
